...
#include "list.h"
//default
DietPlan::DietPlan(int newGoal = 0, string newName = nullptr, string newDate = nullptr)
{
	mGoal = newGoal;
	mName = newName;
	mDate = newDate;
...
DietPlan *DietPlan::getNextPtr() const
{
	return mpNext;
}
//setters
...
void DietPlan::setNextPtr(DietPlan * const pNewNext)
{
	mpNext = pNewNext;
}
